...
const processSteps = [
  ...
  },
  {
    ...
    body: "The plan is written in a lender-friendly structure, then a final review stage flags weak claims and unresolved risks.",
  },
];
    ...
    <div className="marketingShell">
      ...
      <header className="marketingHeader">
        <a className="brand" href="#top" aria-label="Business Plan Writer home">
          ...
          <span>Business Plan Writer</span>
        </a>
      ...
      <main id="main-content">
        <section className="marketingHero" id="top" aria-labelledby="hero-title">
          <div className="heroMessage">
            <p className="marketingEyebrow">Private beta · SBA and bank-loan plans</p>
            <h1 id="hero-title">Turn your business details into a plan a lender can review.</h1>
            <p className="heroLead">
              For first-time local-business owners who need to explain the opportunity,
              the funding request, and the numbers—without starting from a blank document.
            </p>
            ...
            <ul className="offerFacts" aria-label="Offer summary">
              <li><strong>$497</strong><span>one-time beta price</span></li>
              <li><strong>DOCX + PDF</strong><span>editable and shareable</span></li>
              <li><strong>1 revision</strong><span>one consolidated round</span></li>
            </ul>
          </div>
        ...
        <section className="fitSection" aria-labelledby="fit-title">
          ...
          <div className="fitColumns">
            <div>
              <h3>Good fit</h3>
              <p>You run or are launching a local business, are preparing for an SBA or bank-loan conversation, and can provide your own operating assumptions.</p>
            </div>
            <div>
              <h3>Not the right fit</h3>
              <p>You need audited projections, legal or tax advice, original market research, verified citations, or a guarantee that a lender will approve the plan.</p>
            </div>
          </div>
        </section>
        ...
        <section className="deliverablesSection" aria-labelledby="deliverables-title">
          ...
          <div className="deliverablesGrid">
            <article>
              <span>01</span>
              <h3>Lender-friendly plan structure</h3>
        ...
        <section className="processSection" id="process" aria-labelledby="process-title">
          <div className="sectionHeading processHeading">
            ...
            <h2 id="process-title">Five focused jobs, explained in customer language.</h2>
            <p>Each automated stage has a narrow responsibility. The stages do not replace the judgment of you, your lender, accountant, attorney, or advisor.</p>
          </div>
        ...
        <section className="pricingSection" id="pricing" aria-labelledby="pricing-title">
          <div className="pricingIntro">
            <p className="sectionLabel">One private-beta package</p>
            <h2 id="pricing-title">Funding Ready</h2>
            <p>For one business and one SBA or bank-loan use case.</p>
          ...
          <div className="packageDetails">
            ...
            <ul>
              ...
              <li>Full business plan draft</li>
              <li>Automated financial credibility notes</li>
              <li>DOCX and PDF delivery</li>
              <li>One consolidated revision round through beta support</li>
            </ul>
            <div className="expectationNote">
              <strong>Private-beta expectation</strong>
              <p>No payment is collected on this page. Delivery timing is confirmed with beta access because generation and support timing can vary. A revision refines the original plan; it does not cover a new business, new funding use, or independently researched data.</p>
            </div>
            <AnalyticsLink
        ...
        <section className="trustSection" id="trust" aria-labelledby="trust-title">
          ...
          <div className="trustGrid">
            <article id="disclaimer">
              ...
              <p>Your plan is drafted and checked by an automated five-stage workflow. It is not reviewed by a human expert in this package. Review every fact, assumption, and projection before sharing it.</p>
            ...
            <article id="support">
              ...
              <p>Reply to your private-beta invitation for access help, intake questions, file-delivery issues, or your included consolidated revision request.</p>
      ...
      <footer className="marketingFooter">
        <div className="brand footerBrand"><span className="brandMark" aria-hidden="true">BP</span><span>Business Plan Writer</span></div>
        <p>Guided, lender-ready business plans with automated financial credibility review and professional DOCX/PDF delivery.</p>
